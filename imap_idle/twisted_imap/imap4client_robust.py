...
# - as many errback as the original imap client
# - and could also try the CRAM bidule authentication...
# - should use login

# auth is tried and fail back on login

# the cb and eb could really be copied and pasted around to be clearer
